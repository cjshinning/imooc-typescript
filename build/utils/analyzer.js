...
var JennyAnalyzer = /** @class */ (function () {
    function JennyAnalyzer() {
    }
    JennyAnalyzer.getInstance = function () {
        if (!JennyAnalyzer.instance) {
            JennyAnalyzer.instance = new JennyAnalyzer();
        }
        return JennyAnalyzer.instance;
    };
    JennyAnalyzer.prototype.getCourseInfo = function (html) {
    ...
    JennyAnalyzer.prototype.generateJsonContent = function (courseInfo, filePath) {
        var fileContent = {};
